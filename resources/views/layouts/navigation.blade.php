    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                {{-- Enlace para cambiar de Rol si tiene más de uno (siempre visible) --}}
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(!request()->routeIs('dashboard'))
                @if (Auth::user()->hasRole('Administrador') && request()->is('admin*'))
                    ...
                    <x-responsive-nav-link :href="route('admin.especialidades.index')" :active="request()->routeIs('admin.especialidades.*')">
                        {{ __('Especialidades') }}
                    </x-responsive-nav-link>
            ...
            {{-- Enlace para cambiar de Rol si tiene más de uno (Responsive) --}}
            @if (Auth::check() && Auth::user()->roles->count() > 1)
